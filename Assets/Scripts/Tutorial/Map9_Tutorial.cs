...
public class Map9_Tutorial : MonoBehaviour
{
    ...
    void Start()
    {
        if (PlayerPrefs.HasKey("Map9_Tutorial"))
        {
            if (PlayerPrefs.GetInt("Map9_Tutorial") == 1)
            {
    ...
    void Update()
    {
        ...
        if (textDone)
        {
            ...
            textDone = false;
            stage++;
            PlayerPrefs.SetInt("Map9_Tutorial", 1); // remember that this dialogue already happened
        }
    }
