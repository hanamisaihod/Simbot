...
public class Menu_Tutorial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fullText[8] = "Neko: But there was an anomaly during the development. It seems that a virus has invaded the system. Then your father ....";
        fullText[9] = "Neko: I could not do anything...";
        fullText[10] = "Johny: A. .And what can I do!?";
        fullText[11] = "Neko: You have to play this game and take me to the deepest level. If I were there, I can get rid of the virus there!";
        ...
        fullText[14] = "Neko: When you want to play. Just press here.";
        fullText[15] = "";
        fullText[16] = "";
        ...
        fullText[19] = "Neko: If you want to take some rest, press here. I hope to see you again. We have a job to do";
